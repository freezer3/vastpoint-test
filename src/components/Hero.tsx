...
const Hero = () => {
  return <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <nav className="relative z-30 flex items-center justify-between p-8 lg:p-12">
        {/* Logo */}
        <img src="/lovable-uploads/dafb4d3f-0152-4842-a914-877032678787.png" alt="Vastpoint Logo" className="h-8 w-auto" />
        ...
        <div className="pb-8 px-8 lg:pb-12 lg:px-12 w-full">
          ...
          <div>
            ...
            <div className="flex items-center justify-start gap-8">
              ...
              <img src="/lovable-uploads/83de6ac1-d94c-40cb-9394-c6d23c1897d9.png" alt="Co-funded by the European Union" className="h-12 w-auto opacity-80" />
            </div>
          </div>
        </div>
      </div>
